...
public enum GeyserType implements StringRepresentable {
    FLAME("flame", true, 5, FlameGeyserTicker::new, () -> VALID_BLOCKS, ENVIRONMENT.flameGeyserSpawnChance, ENVIRONMENT.flameGeyserActiveTime, ENVIRONMENT.flameGeyserInactiveTime),
    SMOKE("smoke", true, 4, SmokeGeyserTicker::new, () -> VALID_BLOCKS, ENVIRONMENT.smokeGeyserSpawnChance, ENVIRONMENT.smokeGeyserActiveTime, ENVIRONMENT.smokeGeyserInactiveTime);
    ...
    GeyserType(String name, boolean isNetherOnly, int height, TriFunction<Level, BlockPos, RandomSource, GeyserTicker> geyserTickerProvider, Supplier<List<Block>> spawnableBlocks, ValidatedInt spawnChance, ValidatedInt activeTime, ValidatedInt inactiveTime) {
        this.name = name;
