...
import static einstein.subtle_effects.util.CodecUtil.configurableFloatCodec;
...
public record DropletOptions(ColorProviderType.ColorProvider colorProvider,
    ...
    public static final Codec<DropletOptions> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            CodecUtil.SIMPLE_PARTICLE_TYPE_CODEC.optionalFieldOf("land_particle").forGetter(DropletOptions::landParticle)
