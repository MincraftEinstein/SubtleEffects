...
public class ModAnimalFedEffectSettings {
    ...
    public static void init() {
        ...
        register(EntityTypes.COW, ModSounds.COW_EAT);
        register(EntityTypes.MOOSHROOM, SoundEvents.MOOSHROOM_EAT);
        register(EntityTypes.CHICKEN, 0.3, -0.7, ModSounds.CHICKEN_EAT);
        register(EntityTypes.CAT, 0, -0.4);
        register(EntityTypes.OCELOT, 0, -0.3, ModSounds.OCELOT_EAT);
        register(EntityTypes.PANDA, -0.35, 0.3, SoundEvents.PANDA_EAT);
        register(EntityTypes.SHEEP, 0, -0.2, ModSounds.SHEEP_EAT);
        register(EntityTypes.PARROT, 0.2, -0.9, SoundEvents.PARROT_EAT);
        register(EntityTypes.AXOLOTL, new Vec3(0, 0, -0.4), ModSounds.AXOLOTL_EAT,
                stack -> stack.is(Items.TROPICAL_FISH_BUCKET) ? new ItemStack(Items.TROPICAL_FISH) : stack
        );
        register(EntityTypes.CAMEL, 1, 0.6);
        register(EntityTypes.BEE, 0, -0.7, ModSounds.BEE_EAT);
        register(EntityTypes.FROG, 0, -0.7, SoundEvents.FROG_EAT);
        register(EntityTypes.DOLPHIN, 0, -0.2, SoundEvents.DOLPHIN_EAT);
        register(EntityTypes.TADPOLE, 0, -0.9, ModSounds.TADPOLE_EAT);
        register(EntityTypes.FOX, 0, -0.6);
        register(EntityTypes.LLAMA, 0.4, -0.1);
        register(EntityTypes.TRADER_LLAMA, 0.4, -0.1);
        register(EntityTypes.RABBIT, 0, -0.8, ModSounds.RABBIT_EAT);
        register(EntityTypes.SNIFFER, 0, 1.5);
        register(EntityTypes.MULE, 0, 0.2);
        register(EntityTypes.DONKEY, 0, 0.2);
        register(EntityTypes.HORSE, 0.2, 0.4);
        register(EntityTypes.STRIDER, 0, -0.6);
        register(EntityTypes.ARMADILLO, 0, -0.4);
        register(EntityTypes.WOLF, 0, -0.3);
        register(EntityTypes.TURTLE, ModSounds.TURTLE_EAT);
        register(EntityTypes.HOGLIN, ModSounds.HOGLIN_EAT);
    }
