...
public class ModParticles {
    ...
    public static final Supplier<ParticleType<RippleParticleOptions>> RIPPLE = register("ripple", RippleParticleOptions::codec, RippleParticleOptions::streamCodec, RippleParticle.Provider::new);
    ...
    public static final Supplier<ParticleType<RippleParticleOptions>> SPLASH_RIPPLE = register("splash_ripple", RippleParticleOptions::codec, RippleParticleOptions::streamCodec, sprites -> new SplashRippleParticle.Provider());
    ...
    public static final Supplier<SimpleParticleType> ELECTRICITY = register("electricity", ElectricityParticle.Provider::new);
