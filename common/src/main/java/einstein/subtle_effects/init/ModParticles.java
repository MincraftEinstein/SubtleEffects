...
public class ModParticles {
    ...
    public static final Supplier<ParticleType<FloatAndIntegerParticleOptions>> WATER_SPLASH_EMITTER = register("water_splash_emitter", FloatAndIntegerParticleOptions::codec, FloatAndIntegerParticleOptions::streamCodec, sprites -> new SplashEmitter.Provider());
    public static final Supplier<ParticleType<FloatAndIntegerParticleOptions>> LAVA_SPLASH_EMITTER = register("lava_splash_emitter", FloatAndIntegerParticleOptions::codec, FloatAndIntegerParticleOptions::streamCodec, sprites -> new SplashEmitter.LavaProvider());
