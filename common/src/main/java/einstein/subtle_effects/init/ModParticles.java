...
public class ModParticles {
    ...
    public static final RegistrySupplier<ParticleType<ColorParticleOption>> LONG_SPARK = register("long_spark", ColorParticleOption::codec, ColorParticleOption::streamCodec);
    public static final RegistrySupplier<ParticleType<ColorParticleOption>> SHORT_SPARK = register("short_spark", ColorParticleOption::codec, ColorParticleOption::streamCodec);
    public static final RegistrySupplier<ParticleType<ColorParticleOption>> FLOATING_SPARK = register("floating_spark", ColorParticleOption::codec, ColorParticleOption::streamCodec);
    public static final RegistrySupplier<ParticleType<ColorParticleOption>> METAL_SPARK = register("metal_spark", ColorParticleOption::codec, ColorParticleOption::streamCodec);
    ...
    public static final RegistrySupplier<ParticleType<IntegerParticleOptions>> ITEM_RARITY = register("item_rarity", IntegerParticleOptions::codec, IntegerParticleOptions::streamCodec);
    ...
    public static final RegistrySupplier<ParticleType<ColorAndIntegerParticleOptions>> POTION_RING = register("potion_ring", ColorAndIntegerParticleOptions::codec, ColorAndIntegerParticleOptions::streamCodec);
    public static final RegistrySupplier<ParticleType<ColorAndIntegerParticleOptions>> POTION_DOT = register("potion_dot", ColorAndIntegerParticleOptions::codec, ColorAndIntegerParticleOptions::streamCodec);
    public static final RegistrySupplier<ParticleType<ColorAndIntegerParticleOptions>> POTION_EMITTER = register("potion_emitter", ColorAndIntegerParticleOptions::codec, ColorAndIntegerParticleOptions::streamCodec);
    ...
    public static final RegistrySupplier<ParticleType<ColorParticleOption>> ENDER_EYE_PLACED_RING = register("ender_eye_placed_ring", ColorParticleOption::codec, ColorParticleOption::streamCodec);
    ...
    public static final RegistrySupplier<ParticleType<ColorParticleOption>> POTION_CLOUD = register("potion_cloud", ColorParticleOption::codec, ColorParticleOption::streamCodec);
