...
public class SparkParticle extends TextureSheetParticle {
    ...
    public static ColorParticleOptions create(SparkType sparkType, ColorProviderType.ColorProvider colorProvider, Level level, BlockPos pos, RandomSource random) {
        Vector3f color = colorProvider.provideColor(level, pos, random);
        return new ColorParticleOptions(sparkType.getType().get(), color);
    }
