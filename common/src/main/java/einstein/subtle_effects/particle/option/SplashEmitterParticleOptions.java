...
public record SplashEmitterParticleOptions(Identifier fluidDefinitionId, float widthModifier,
    ...
    public static final MapCodec<SplashEmitterParticleOptions> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
                    Identifier.CODEC.fieldOf("fluid_definition").forGetter(SplashEmitterParticleOptions::fluidDefinitionId),
    ...
    public static final StreamCodec<ByteBuf, SplashEmitterParticleOptions> STREAM_CODEC = StreamCodec.composite(
            Identifier.STREAM_CODEC, SplashEmitterParticleOptions::fluidDefinitionId,
