...
public record RippleParticleOptions(ParticleType<RippleParticleOptions> type, Identifier fluidDefinitionId,
    ...
    public static MapCodec<RippleParticleOptions> codec(ParticleType<RippleParticleOptions> type) {
        return RecordCodecBuilder.mapCodec(instance -> instance.group(
                Identifier.CODEC.fieldOf("fluid_definition").forGetter(RippleParticleOptions::fluidDefinitionId),
    ...
    public static StreamCodec<RegistryFriendlyByteBuf, RippleParticleOptions> streamCodec(ParticleType<RippleParticleOptions> type) {
        return StreamCodec.composite(
                Identifier.STREAM_CODEC, RippleParticleOptions::fluidDefinitionId,
