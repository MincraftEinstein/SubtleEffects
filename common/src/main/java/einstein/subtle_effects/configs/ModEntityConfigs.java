...
public class ModEntityConfigs extends Config {
    ...
    public final ValidatedDouble snowballTrailDensity = new ValidatedDouble(0.2, 1, 0, ValidatedNumber.WidgetType.TEXTBOX);
    public final ValidatedDouble allayMagicDensity = new ValidatedDouble(0.2, 1, 0, ValidatedNumber.WidgetType.TEXTBOX);
    public final ValidatedDouble vexMagicDensity = new ValidatedDouble(0.2, 1, 0, ValidatedNumber.WidgetType.TEXTBOX);
