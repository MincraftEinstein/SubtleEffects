...
public class BiomeConfigs extends ConfigSection {
    ...
    public ValidatedCondition<List<? extends Identifier>> mushroomSporeBiomes = conditionalBiomeList(mushroomSporeDensity, "mushroom_fields");
    public ValidatedCondition<Integer> pollenDensity = conditional(new ValidatedInt(50, 100, 0), biomeParticlesRadius);
    public ValidatedCondition<List<? extends Identifier>> pollenBiomes = conditionalBiomeList(pollenDensity, "flower_forest", "sunflower_plains");
    public ValidatedCondition<Integer> sculkDustDensity = conditional(new ValidatedInt(5, 100, 0), biomeParticlesRadius);
    public ValidatedCondition<List<? extends Identifier>> sculkDustBiomes = conditionalBiomeList(sculkDustDensity, "deep_dark");

    private ValidatedCondition<List<? extends Identifier>> conditionalBiomeList(ValidatedField<Integer> dependencyConfig, String... biomeIds) {
